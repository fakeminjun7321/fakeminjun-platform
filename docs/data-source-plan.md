...
| [ACLED API](https://acleddata.com/api-documentation/getting-started) | 세부 분쟁·시위 사건 | 후속 후보 | 계정·인증과 이용 조건 검토 필요 | 공식 문서 확인, 실제 호출 미검증 |
...
2. 현재 진행 중인 국제정세 API 1개로 첫 세로 조각을 끝까지 검증한 뒤 물리 자료 연결을 다음 세로 조각으로 추가한다.
