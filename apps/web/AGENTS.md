...
- Politics is a Korea-primary desk with the United States as secondary context. Its frontend should explain decision makers, institutional procedure, and basic political structure with an adjustable demo level; all prototype agendas must be labeled as demo cases rather than current political facts.
