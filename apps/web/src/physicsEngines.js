export const PHYSICS_AI_ENGINES = Object.freeze({
  ps: Object.freeze({
    ...
    profiles: Object.freeze({
      standard: Object.freeze({ mode: "standard", title: "AXIOM S1", task: "빠른 풀이", trait: "핵심 경로·답 확인" }),
      auto: Object.freeze({ mode: "auto", title: "AXIOM S1", task: "표준 풀이", trait: "유도·SVG·검산" }),
      deep: Object.freeze({ mode: "deep", title: "AXIOM S1", task: "정밀 검산", trait: "독립 풀이·오류 추적" }),
    }),
  }),
  te: Object.freeze({
    id: "te",
    ...
    profiles: Object.freeze({
      standard: Object.freeze({ mode: "standard", title: "THEORIA T1", task: "핵심 설명", trait: "직관·정의" }),
      auto: Object.freeze({ mode: "auto", title: "THEORIA T1", task: "구조 설명", trait: "수학·연결·SVG" }),
      deep: Object.freeze({ mode: "deep", title: "THEORIA T1", task: "심층 이론", trait: "유도·반례·경계" }),
    }),
  }),
});
